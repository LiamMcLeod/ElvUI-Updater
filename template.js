...
function getLocalVer() {
	return new Promise((resolve, reject) => {
		var path = "M:/WoW/_retail_/Interface/addons/ElvUI/ElvUI.toc"
...
function getServerVer() {
	return new Promise((resolve, reject) => {
		var url = "https://git.tukui.org/elvui/elvui/-/raw/main/ElvUI/ElvUI.toc"
		var options = {
			url: url,
		}
...
function compareResults() {
	return new Promise((resolve, reject) => {
		if (localVer == serverVer) {
			...
			dl("direct:https://git.tukui.org/elvui/elvui/-/archive/main/elvui-main.zip", "./temp", (err) => {
				if (err) {
					resolve(1)
				} else {
					resolve(2)
...
function copyRepo() {
	var src = "./temp";
	var dest = "M:/WoW/_retail_/Interface/addons/";
